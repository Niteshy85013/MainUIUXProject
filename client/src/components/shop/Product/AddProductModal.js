...
const AddProductDetail = ({ categories }) => {
  ...
  return (
    <Fragment>
      ...
      >
        <div className="mt-32 md:mt-0 relative bg-white w-14/14 md:w-3/6 shadow-lg flex flex-col items-center space-y-4 px-4 py-4 md:px-8">
          ...
          <form className="w-full" onSubmit={(e) => submitForm(e)}>
            ...
            <div className="flex flex-col space-y-1 w-full pb-4 md:pb-2 mt-4">
              <button
