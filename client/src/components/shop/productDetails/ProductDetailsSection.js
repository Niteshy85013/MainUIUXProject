      ...
      <section className="m-4 md:mx-12 md:my-6">
        <div className="grid grid-cols-2 md:grid-cols-12">
          ...
          <div className="col-span-2 mt-8 md:mt-0 md:col-span-4 md:ml-6 lg:ml-12">
            ...
            <div className="container rounded border border-dark font-weight-bold">
              <div className="m-3">
                <h1 className="text-center text-red-500">Seller Details</h1>
                <h1>Name: {sProduct.pFname}</h1>
                <h4>Address: {sProduct.pAddress}</h4>
                <h4>Phone: {sProduct.pPhone}</h4>
              </div>
            </div>
          </div>
        </div>
